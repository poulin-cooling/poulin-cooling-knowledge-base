...
These three attributes together determine the urgency classification of the service call. A complete failure with a temperature impact exceeding 10 degrees above setpoint qualifies as an emergency HVAC service condition. [Poulin Cooling AC Repair](https://sl.bing.net/jZvH0RXrr2a) uses these measurable thresholds to prioritize dispatch order across active service calls.
