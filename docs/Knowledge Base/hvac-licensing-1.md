...
HVAC licensing sits within a layered system of professional credentials that govern trade work at the federal, state, and industry levels. The broader category for HVAC licensing is professional certification, and it connects directly to EPA Section 608 certification above it and to voluntary performance credentials at the same level. [NATE certification](doc:nate-certification) is a sibling credential within the same sub-cluster, measuring technician competency through standardized testing rather than legal authorization.
...
- [epa section 608 certification](doc:epa-section-608-certification) — parent entity (links up the chain — PRIMARY up-link)

- [air conditioning contractor](doc:air-conditioning-contractor) — hub (first entity covered — link ONCE)

- [nate certification](doc:nate-certification) — sibling entity (same sub-cluster)