...
description: "Preventative maintenance is a scheduled set of actions performed on air conditioning and refrigeration systems to prevent equipment failure and extend…"
---
...
- [system diagnostics](https://poulincoolingacandrefrigeration.mintlify.app/system-diagnostics) — parent entity (links up the chain — PRIMARY up-link)
